...
class Scripter:
    ...
    def generate_campaign(self, context: str, rule_system: str = "coc7e"):
        """Generate + validate a campaign. Returns (yaml_text, None) or (None, error_string).
        One repair round-trip if validation fails."""
        ...
        instruction = ARCHITECT_INSTRUCTION_TEMPLATE.format(
            rule_system=rule_system, difficulties=system.difficulty_levels, stress_rule=stress_rule)
